...
class CdDataset(paddle.io.Dataset):
    def __init__(self, input_dir, index_list):
        self.cd_list = np.loadtxt("/home/xusuyong/pythoncode/xsy_datasets/CIKM_dataset/AIstudio_CIKM_dataset/Training/Dataset_2/Label_File/dataset2_train_label.csv", delimiter=",", dtype=str, encoding='utf-8')[:,2][1:].astype(np.float32)
